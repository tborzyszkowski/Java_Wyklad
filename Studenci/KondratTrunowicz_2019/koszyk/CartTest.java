...
public class CartTest {
    ...
    public void conslusion300withRabat(){
        Product product = new Product (1111,"Telewizor",300);
        Product product2 = new Product (2222,"Laptop",100);
        Product product3 = new Product (3333,"Cola",100);
        Cart cart = new Cart();
        cart.addProduct(product2);
        cart.addProduct(product);
        cart.addProduct(product3);
        ...
        cart.conclusionWithRabat("Telewizor");
        cart.SumaRabat();
        Assert.assertEquals(cart.getSumaRabat(), 380,0.1);
    }
    @Test
