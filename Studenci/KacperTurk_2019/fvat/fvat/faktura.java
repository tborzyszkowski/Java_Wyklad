...
public class faktura {
    ...
    public faktura(klient klientF,sprzedajacy sprzedajacyF, String data_wystawienia, String data_sprzedazy, String data_zaplaty) {
        setValues(klientF,sprzedajacyF,data_wystawienia,data_sprzedazy,data_zaplaty);
    }

    public faktura(klient klientF,sprzedajacy sprzedajacyF) {
        setValues(klientF, sprzedajacyF, new SimpleDateFormat("dd-MM-yyyy").format(new Date()), new SimpleDateFormat("dd-MM-yyyy").format(new Date()),
                new SimpleDateFormat("dd-MM-yyyy").format(new Date()));
    }

    public faktura() {
        setValues(new klient(), new sprzedajacy(), new SimpleDateFormat("dd-MM-yyyy").format(new Date()),
                new SimpleDateFormat("dd-MM-yyyy").format(new Date()), new SimpleDateFormat("dd-MM-yyyy").format(new Date()));
    }

    private void setValues(klient klientF,sprzedajacy sprzedajacyF, String data_wystawienia, String data_sprzedazy, String data_zaplaty){
