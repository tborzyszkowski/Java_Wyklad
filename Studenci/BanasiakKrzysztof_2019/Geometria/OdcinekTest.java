...
public class OdcinekTest {
    ...
    public void sprawdzenieXwodcinkuzpunktu() {
        ...
        Assert.assertEquals(0, odcinek.getPierwszyX(), 0.001);
    }
    @Test
    public void sprawdzenieYwodcinkuzpunktu() {
        ...
        Punkt newPunkt = new Punkt();
        Odcinek odcinek = new Odcinek(newPunkt,4,0);
        Assert.assertEquals(0, odcinek.getPierwszyY(), 0.001);
    }
    @Test
    ...
    @Test
    public void swiftOdcinektest1() {

        Punkt newPunkt1 = new Punkt();
        Punkt newPunkt2 = new Punkt(7,7);
        Odcinek odcinek = new Odcinek(newPunkt1,newPunkt2);
        odcinek.swiftOdcinek(1,1);
        Assert.assertEquals(1,odcinek.getPierwszyX(), 0.001);

    }
    @Test
    public void swiftOdcinektest2() {

        Punkt newPunkt1 = new Punkt();
        Punkt newPunkt2 = new Punkt(7,7);
        Odcinek odcinek = new Odcinek(newPunkt1,newPunkt2);
        odcinek.swiftOdcinek(1,1);
        Assert.assertEquals(1,odcinek.getPierwszyY(), 0.001);


    }
    @Test
    public void swiftOdcinektest3() {

        Punkt newPunkt1 = new Punkt();
        Punkt newPunkt2 = new Punkt(7,7);
        Odcinek odcinek = new Odcinek(newPunkt1,newPunkt2);
        odcinek.swiftOdcinek(1,1);
        Assert.assertEquals(8,odcinek.getDrugiX(), 0.001);

    }
    @Test
    public void swiftOdcinektest4() {

        Punkt newPunkt1 = new Punkt();
        Punkt newPunkt2 = new Punkt(7,7);
        Odcinek odcinek = new Odcinek(newPunkt1,newPunkt2);
        odcinek.swiftOdcinek(1,1);
        Assert.assertEquals(8,odcinek.getDrugiY(), 0.001);
